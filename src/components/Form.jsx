...
const Form = ({
  ...
  const handleDivClick = () => {
    if (fileInputRef.current) {
      fileInputRef.current.click(); // Trigger the hidden input's click event
    }
  };
      ...
      <DndProvider backend={HTML5Backend}>
        <div className="file-upload-container relative pb-10">
          ...
          {fileType !== "text" &&
            (fileType === "audio" ? (
              <div className="pt-2">
                <h1 className="my-2 mb-4">Select Audio</h1>

                {/* <Upload {...props} audioFile={audioFile}>
                ...
                />
                <div
                  className="bg-transparent flex items-center gap-1 justify-center border-[1px] rounded-lg border-gray-500 cursor-pointer  w-[100px] text-center p-1"
              ...
              >
                <div>
                  <div>
                    <p className="my-2">
                      Click to select{" "}
                      {fileType === "image" ? "images" : "a video"} file{" "}
                      {fileType === "image"
